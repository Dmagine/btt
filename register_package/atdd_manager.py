...
class ATDDManager:
    ...
    def calculate_after_validating(self, *args): # {"rule_name1":args_dict1, "rule_name2":args_dict2, ...}
        if self.monitor_config is not None:
            self.monitor.calculate_after_validating(*args)
    ...
    def init_basic(self, *args):
        if self.monitor_config is not None:
            ...
            self.refresh_before_epoch_start()
