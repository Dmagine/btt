...
class MyLSTM(nn.Module):
    def __init__(self):
        ...
        self.lstm1 = nn.LSTM(28, params["hidden_size1"], batch_first=True)
        self.lstm2 = nn.LSTM(params["hidden_size1"], params["hidden_size2"], batch_first=True)
        self.relu = choose_act()
        self.mlp1 = nn.Linear(params["hidden_size2"], params["mlp_f_num"])
    ...
    def forward(self, x):
        ...
        x, (h_n, h_c) = self.lstm1(x, None)
        x, (h_n, h_c) = self.lstm2(x, None)
