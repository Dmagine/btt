...
def main():
    ...
    #   --train_epochs 100 \
    #   --patience 10
    args.task_name = "classification" # 7s/epoch -> 15min/trial loss在降但是acc好像不会变 val一直不太好 lr太小
    args.train_epochs = 100
    args.patience = args.train_epochs
    args.is_training = True
    args.root_path = "../../../data/dataset/EthanolConcentration/"
    ...
    args.d_ff = params["d_ff"]  # choice 128,256,512
