...
def conn():
    ...
    # sql = "PRAGMA table_info(ExperimentProfile)"
    # cur.execute(sql)
    # values = cur.fetchall()
    # print(values)
    # [(0, 'params', 'text', 0, None, 0), (1, 'id', 'text', 0, None, 0), (2, 'execDuration', 'integer', 0, None, 0),
    # (3, 'startTime', 'integer', 0, None, 0), (4, 'endTime', 'integer', 0, None, 0),
    # (5, 'logDir', 'text', 0, None, 0), (6, 'nextSequenceId', 'integer', 0, None, 0),
